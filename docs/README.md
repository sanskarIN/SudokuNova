...
This directory contains implementation-aligned documentation for SudokuNova. A feature is described as implemented only when corresponding source code exists in the repository; future work is clearly marked as planned.
...
- Current implementation log: [`../what_changed.md`](../what_changed.md)
