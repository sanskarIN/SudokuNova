...
class HistoryRepository(context: Context) {
    ...
    suspend fun getHistory(id: Long): GameHistoryEntity? = historyDao.getById(id)
    ...
    suspend fun getSavedPuzzle(id: Long): SavedPuzzleEntity? = savedPuzzleDao.getById(id)

    suspend fun findSavedPuzzle(puzzle: String): SavedPuzzleEntity? = savedPuzzleDao.getByPuzzle(puzzle)
