    ...
    Card(modifier = Modifier.fillMaxWidth()) {
        Column(Modifier.padding(16.dp)) {
            Row(
                ...
                Text(
                    if (result != null) {
                        stringResource(R.string.v06_completed)
                    } else {
                        stringResource(R.string.v06_not_completed)
                    },
            ...
            Button(
                ...
                Text(
                    if (result == null) {
                        stringResource(R.string.v06_play_challenge)
                    } else {
                        stringResource(R.string.v06_replay_challenge)
                    },
                )
            }
        }
