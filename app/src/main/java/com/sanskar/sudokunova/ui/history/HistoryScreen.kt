...
fun HistoryRoute(
    onBack: () -> Unit,
    onReplay: (GameHistoryEntity) -> Unit,
...
private fun HistoryScreen(
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            item {
                DifficultyFilterRow(state.difficulty, onDifficulty)
            }
            ...
            if (state.summaries.isNotEmpty()) {
                ...
                items(state.summaries, key = { "summary-${it.difficulty}" }) {
                    DifficultySummaryCard(it)
                }
            }
    ...
    Card(modifier = Modifier.fillMaxWidth()) {
        Column(Modifier.padding(14.dp)) {
            ...
            Row(
                ...
                if (item.isPerfect) Text(stringResource(R.string.v05_perfect_badge))
                if (item.replayOfHistoryId != null) Text(stringResource(R.string.v05_replay_badge))
            }
